...
const CabinetFrame3D: React.FC<CabinetFrame3DProps> = ({
  uHeight,
  width,
  depth,
}) => {
...
const EmptySlot3D: React.FC<EmptySlot3DProps> = ({
  startU,
  endU,
  width,
  depth,
    ...
    >
      <div className={styles.container}>
        ...
        <div className={styles.footer}>
          <span>
            设备总数: <strong>{devices.length}</strong>
          </span>
          <span>
            在线:{' '}
