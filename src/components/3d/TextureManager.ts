...
export function getCachedBoxGeometry(
  ...
  const cachedGeometry = boxGeometryCache.get(key);
...
export function getCachedSphereGeometry(
  ...
  const cachedGeometry = sphereGeometryCache.get(key);
  if (cachedGeometry) return cachedGeometry;
...
export const DeviceMaterials = {
  // 服务器
  serverBody: getCachedMaterial({
    color: '#5c6b7a',
    metalness: 0.5,
    roughness: 0.4,
  }),
  serverBodyHover: getCachedMaterial({
    color: '#7a8fa3',
    metalness: 0.5,
    roughness: 0.4,
  }),
  serverPanel: getCachedMaterial({
    color: '#2a2f35',
    metalness: 0.3,
    roughness: 0.6,
  }),
  ...
  // 交换机
  switchBody: getCachedMaterial({
    color: '#2d5a7b',
    metalness: 0.4,
    roughness: 0.5,
  }),
  switchBodyHover: getCachedMaterial({
    color: '#4a7c9b',
    metalness: 0.4,
    roughness: 0.5,
  }),
  switchPanel: getCachedMaterial({
    color: '#1a2530',
    metalness: 0.3,
    roughness: 0.6,
  }),
  ...
  // 路由器
  routerBody: getCachedMaterial({
    color: '#4a6b5c',
    metalness: 0.4,
    roughness: 0.5,
  }),
  routerBodyHover: getCachedMaterial({
    color: '#6b8e7d',
    metalness: 0.4,
    roughness: 0.5,
  }),
  routerPanel: getCachedMaterial({
    color: '#1f2d25',
    metalness: 0.3,
    roughness: 0.6,
  }),
  ...
  // 存储
  storageBody: getCachedMaterial({
    color: '#483d8b',
    metalness: 0.4,
    roughness: 0.5,
  }),
  storageBodyHover: getCachedMaterial({
    color: '#6a5acd',
    metalness: 0.4,
    roughness: 0.5,
  }),
  storagePanel: getCachedMaterial({
    color: '#1a1525',
    metalness: 0.3,
    roughness: 0.6,
  }),
  ...
  // 防火墙
  firewallBody: getCachedMaterial({
    color: '#8b0000',
    metalness: 0.4,
    roughness: 0.5,
  }),
  firewallBodyHover: getCachedMaterial({
    color: '#cd5c5c',
    metalness: 0.4,
    roughness: 0.5,
  }),
  ...
  // 负载均衡器
  loadbalancerBody: getCachedMaterial({
    color: '#008b8b',
    metalness: 0.4,
    roughness: 0.5,
  }),
  loadbalancerBodyHover: getCachedMaterial({
    color: '#20b2aa',
    metalness: 0.4,
    roughness: 0.5,
  }),
  ...
  // 通用设备
  genericBody: getCachedMaterial({
    color: '#6b7b8c',
    metalness: 0.4,
    roughness: 0.5,
  }),
  genericBodyHover: getCachedMaterial({
    color: '#8fa3b8',
    metalness: 0.4,
    roughness: 0.5,
  }),
...
export const StatusMaterials = {
  online: getCachedMaterial({
    color: '#52c41a',
    emissive: '#52c41a',
    emissiveIntensity: 0.3,
  }),
  offline: getCachedMaterial({
    color: '#8c8c8c',
    emissive: '#4a4a4a',
    emissiveIntensity: 0.1,
  }),
  warning: getCachedMaterial({
    color: '#faad14',
    emissive: '#faad14',
    emissiveIntensity: 0.5,
  }),
  error: getCachedMaterial({
    color: '#f5222d',
    emissive: '#f5222d',
    emissiveIntensity: 0.5,
  }),
  maintenance: getCachedMaterial({
    color: '#1890ff',
    emissive: '#1890ff',
    emissiveIntensity: 0.3,
  }),
...
export const LEDMaterials = {
  active: getCachedMaterial({
    color: '#00ff00',
    emissive: '#00ff00',
    emissiveIntensity: 0.8,
  }),
  inactive: getCachedMaterial({
    color: '#333',
    emissive: '#000',
    emissiveIntensity: 0,
  }),
  activeBlue: getCachedMaterial({
    color: '#1890ff',
    emissive: '#0066cc',
    emissiveIntensity: 0.6,
  }),
  activeGreen: getCachedMaterial({
    color: '#52c41a',
    emissive: '#52c41a',
    emissiveIntensity: 0.5,
  }),
...
export function clearAllCaches(): void {
  ...
  // 清理几何体
  boxGeometryCache.forEach((geometry) => {
    geometry.dispose();
  });
  boxGeometryCache.clear();

  sphereGeometryCache.forEach((geometry) => {
    geometry.dispose();
  });
...
export function getCacheStats(): {
  materials: number;
  boxGeometries: number;
  sphereGeometries: number;
} {
  return {
